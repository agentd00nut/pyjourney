...
class  GetJobsArgs:
    ...
    def __init__(self, amount=35, dedupe=True, jobStatus="completed", orderBy="new", prompt="undefined", refreshApi="0", searchType="advanced", service="null", type="all", userId="", user_id_ranked_score="null", _ql="todo", _qurl="https://www.midjourney.com/app/"):
        self.amount = amount
        self.dedupe = dedupe
    ...
    # It iterates over the given dictionary and sets the values of this class to the values of the given dictionary
    @classmethod
